...
Claude Code-specific. Uses Anthropic's in-app plugin marketplace. Not
available in Cursor, Windsurf, or other clients — they each have their own
extension surfaces (Cursor and Windsurf use native skills; OpenSkills covers
the rest).
